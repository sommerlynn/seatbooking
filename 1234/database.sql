...
ALTER VIEW seat_log_view AS
        SELECT user.*, seat_log.classroom_id, seat_log.seat_code, seat_log.log_type, seat_log.log_time, seat_log.log_msg, seat_log.order_date, seat_log.original_openid, seat_log.order_id, area_classroom_view.full_name, seat_log.log_id
