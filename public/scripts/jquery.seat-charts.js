    ...
    var fn       = this,
        ...
        seat = (function(seatCharts, seatChartsSettings) {
          return function (setup) {
            ...
            fn.settings = $.extend({
              status : setup.character == 'a' || setup.character == 'w' || setup.character == 'p' || setup.character == 'm'?'available':'unavailable', //available, unavailable, selected
              style  : setup.character == 'a' || setup.character == 'w' || setup.character == 'p' || setup.character == 'm'?'available':'unavailable',
