...
start_time, end_time, order_time, leave_time, sign_time, schedule_recover_time, real_recover_time, user_seat_order.status, openid, nickname, sex, headimgurl,
...
ALTER VIEW seat_log_view AS
        SELECT user.*, seat_log.classroom_id, seat_log.seat_code, seat_log.log_type, seat_log.log_time, seat_log.log_msg, area_classroom.full_name
